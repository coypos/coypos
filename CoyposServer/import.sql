...
create trigger trg_UpdateDate_TransactionsLog
    on dbo.TransactionsLog
    after insert, update
    as
    begin
        update t
...
disable trigger trg_UpdateDate_TransactionsLog on Receipts
go
...
create trigger trg_UpdateDate_Transactions
    on dbo.Transactions
    after insert, update
    as
    begin
...
disable trigger trg_UpdateDate_Transactions on Transactions
go
...
INSERT INTO COYPOS.dbo.Employees (ID, Name, CardID, PIN, Enabled, Admin) VALUES (1, N'admin', N'1234', N'1234', 1, 1);
go